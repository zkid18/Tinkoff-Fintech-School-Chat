...
//            _ = MultipeerCommunicator(peerID: MCPeerID(displayName: "Daniil Chepenko - simulator"))
//            print("simulator")
//        } else {
//            _ = MultipeerCommunicator(peerID: MCPeerID(displayName: "Daniil Chepenko - device"))
//            print("device")
//        }
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "appIsInBackGround"), object: nil)
